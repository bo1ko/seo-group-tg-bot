...
admin_menu = ReplyKeyboardMarkup(
    keyboard=[
        ...
        [
            ...
            KeyboardButton(text="Налаштування доступів"),
        ],
        [
            KeyboardButton(text="Сховати адмін меню"),
            KeyboardButton(text="Інформація про користувачів"),
        ],
    ],
...
hide_admin_menu = ReplyKeyboardMarkup(
    keyboard=[[KeyboardButton(text="Відкрити адмін меню")]],
    resize_keyboard=True,
    input_field_placeholder="Виберіть пункт меню...",
)

account_add = ReplyKeyboardMarkup(
    keyboard=[
...
account_manage = ReplyKeyboardMarkup(
    keyboard=[
...
stop_add_chats = ReplyKeyboardMarkup(
    keyboard=[
...
start_add_chats = ReplyKeyboardMarkup(
    keyboard=[
...
stop_chat_checker = ReplyKeyboardMarkup(
    keyboard=[
...
start_chat_checker = ReplyKeyboardMarkup(
    keyboard=[
...
users_manage = ReplyKeyboardMarkup(
    keyboard=[
        [
        ...
        [
            KeyboardButton(text="Добавити користувача"),
